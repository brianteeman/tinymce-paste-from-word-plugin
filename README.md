...
tinymce.PluginManager.load(
  "paste_from_word",
  "https://unpkg.com/@stumpdotworks/tinymce-paste-from-word-plugin@latest/index.js",
);
tinymce.init({
...
```bash
npm install @stumpdotworks/tinymce-paste-from-word-plugin
# or
yarn add @stumpdotworks/tinymce-paste-from-word-plugin
```
...
```bash
npm install @tinymce/tinymce-react @stumpdotworks/tinymce-paste-from-word-plugin
```
...
import PasteFromWord from "@stumpdotworks/tinymce-paste-from-word-plugin";
